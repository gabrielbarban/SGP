 ...
 * @author rm70347
 */
public class pesquisarLinha extends HttpServlet {
       ...
       int contador=1;
        ...
        try{
         Class.forName("com.mysql.jdbc.Driver");
            ...
            String sql = "Select numero, titulo, responsavel, coResponsavel, contato, equipe, processo, linha, objetivosPrincipais, resumo, metasAno1, metasAno2, metasAno3, metasAno4, inicio, previsaoFim, situacao, centro, nucleo, prazo, obs from projeto where linha='"+linha+"'";
        ...
        out.println("<tr><td><b>Observação: </b></td><td>"+rs.getString("obs")+"</td></tr></table>");
            ...
            out.println("<BR><BR><BR><BR><input type=\"submit\" value=\"Voltar\" onclick=\"location.href='pesquisarLinha.jsp?status' \">");
            rs.close();
            s.close();
            con.close();
