 ...
 * @author Gabriel
 */
public class pesquisarProcesso extends HttpServlet {
       ...
       String obs = request.getParameter("obs");
        ...
        try{
         Class.forName("com.mysql.jdbc.Driver");
            ...
            String sql = "Select numero, titulo, responsavel, coResponsavel, contato, equipe, processo, linha, objetivosPrincipais, resumo, metasAno1, metasAno2, metasAno3, metasAno4, inicio, previsaoFim, situacao, centro, nucleo, prazo, obs from projeto where processo='"+processo+"'";
        ...
        {
        out.println("<body><table border=\"1\"><tr><td><b>Número: </b></td><td>"+numero+"</td></tr>");
        ...
        out.println("<BR><BR><BR><BR><input type=\"submit\" value=\"Voltar\" onclick=\"location.href='pesquisarProcesso.jsp' \">");
