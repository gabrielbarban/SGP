  ...
  if (texto.substring(0,1) != saida){
    ...
    <br><br>
        ...
        <div id="tudo">
            ...
            <div id="tudo1">
            <br>
            <center><h3>Novo Projeto para avaliação</h3></center><hr>
            <br>
         <form method="post" action="Cadastrar2" name="cadastro">
                
            <table>
            <tr><td><b><label>Titulo: </label></b></td><td><textarea name="titulo" rows="5" cols="75"></textarea></td></tr>
                       
            <tr><td><b><label>Co-responsável: </label></b></td><td><textarea name="coResponsavel" rows="5" cols="75"></textarea></td></tr>
            
            <tr><td><b><label>Telefone: </label></b></td><td><input type="text" name="ddd" value=""  placeholder="ddd" size="3" maxlength="2" /><input type="text" name="telefone" value=""  placeholder="Telefone" size="14" maxlength="9"/></td></tr>
            
            <tr><td><b><label>E-mail: </label></b></td><td><input type="text" name="email" value="" size="19" /></td></tr>
            
            <tr><td><b>Equipe: </b></td><td><textarea name="equipe" rows="5" cols="75"></textarea></td></tr>
            ...
            <tr><td><b>Objetivos principais: </b></td><td><textarea name="objetivosPrincipais" rows="5" cols="75"></textarea></td></tr>
            
            <tr><td><b>Resumo: </b></td><td><textarea name="resumo" rows="20" cols="75"></textarea></td></tr>
            
            <tr><td><b>Metas: </b></td><td><textarea name="metas" rows="6" cols="75"></textarea></td></tr>
            
             <tr><td><b>Abrangência: </b></td><td><textarea name="abrangencia" rows="6" cols="75"></textarea></td></tr>
            
            <tr><td><b>Relevância/Aplicação: </b></td><td><textarea name="relevancia" rows="6" cols="75"></textarea></td></tr>
            
            <tr><td><b>Data de início do Projeto: </b></td><td>
            ...
            <tr><td><b>Data de finalização do Projeto: </b></td><td>
            ...
            <tr><td><b>Centro: </b></td><td><textarea name="centro" rows="1" cols="75"></textarea></td></tr>
            
            <tr><td><b>Nucleo: </b></td><td><textarea name="nucleo" rows="1" cols="75"></textarea></td></tr>
            ...
            <tr><td><b>Custo Global: </b></td><td><input type="text" name="custoGlobal" value="" placeholder="R$"/></td></tr>
            
          
            <tr><td><b>Obs.: </b></td><td><textarea name="obs" rows="3" cols="75"></textarea></td></tr>
       ...
       { 
           ...
           request.getRequestDispatcher("Cadastrar2").forward(request, response);           
