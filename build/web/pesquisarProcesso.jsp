    ...
    <br><br>
       ...
       <div id="tudo">
        ...
        <div id="tudo1">
         ...
         <center><input type="submit" value="Pesquisar pelo Número do Processo" onclick="location.href='pesquisarProcesso.jsp' "></center>
         <br>
         <center><form name="pesquisa" method="POST">
            Processo: <input type="text" name="processo" value="" size="20" />  
            <input type="submit" value="Pesquisar" name="enviar" />
             </form></center>
        <br>
        
         <center><input type="submit" value="Pesquisar pela Linha" onclick="location.href='pesquisarLinha.jsp' "></center><BR>
        
         <center><input type="submit" value="Pesquisar pelo Situação" onclick="location.href='pesquisarSituacao.jsp' "></center><BR>
        
         <center><input type="submit" value="Pesquisar pelo Responsável" onclick="location.href='pesquisarResponsavel.jsp' "></center>
           ...
           if(processo != null)
       {
           ...
           request.getRequestDispatcher("pesquisarProcesso").forward(request, response);           
       }
