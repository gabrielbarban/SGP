...
#rodape{
    ...
    <div id="tudo">
     ...
     <div id="tudo1">
       ...
       <center> <input type="submit" value="Pesquisar pelo Situação" onclick="location.href='pesquisarSituacao.jsp' "></center>
       <Br>
           ...
           if(situacao != null)
       {
           ...
           request.getRequestDispatcher("pesquisarSituacao").forward(request, response);           
       }
