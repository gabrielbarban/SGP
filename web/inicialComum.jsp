  ...
  <body background="mobile_r.jpg" bgproperties="fixed" background="transparent">
    ...
    <br><br>
        ...
        <div id="tudo1">
            ...
            <br>
           <input type="submit" value="Meus Projetos" onclick="location.href='PesquisaUsuario' "><Br>
        <input type="submit" value="Enviar novo Projeto" onclick="location.href='condicoes.jsp' ">
