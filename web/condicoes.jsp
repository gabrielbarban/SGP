    ...
    <br><br>
     ...
     <div id="tudo">
         <div id="tudo1">
             ...
             <br>
             <br>
             <center><input type="submit" value="Concordo" onclick="location.href='cadastrar2.jsp' "> <input type="submit" value="Não concordo" onclick="location.href='inicialComum.jsp' "></center>
        <br><br>
