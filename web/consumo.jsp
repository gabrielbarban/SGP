...
<html>
    <head>
         ...
         <script language="javascript">
            ...
            var table = document.getElementById("consumo");
            ...
            var newRow = table.insertRow(numOfRows);
                ...
                newCell.innerHTML = "<td><input type='text' name='item' value='' size='10'/></td>";
                ...
                newCell.innerHTML = "<td><input type='text' name='custoItem' value='' placeholder='R$' /></td>";
                
                newCell = newRow.insertCell(4);
                newCell.innerHTML = "<td><input type='text' name='fonte' value=''  size='12' /></td>";
    ...
    <br><br>
     ...
     <div id="tudo">
        ...
        <div id="tudo1">
             <form action="Consumo" >
             <br>
            <center><h3>Materiais de Consumo:</h3></center><hr>
           ...
           <br><br>
                 ...
                 Você utilizou materiais de consumo? <br>
...
<table id="consumo">
                <tr>
                    <td>Item: </td><td>Descrição: </td><td>Preço unitário: </td><td>Custo item: </td><td>Fonte: </td></tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="custoItem" value="" placeholder="R$" /></td>
                    <td><input type="text" name="fonte" value=""  size="12" /></td>
