...
#rodape{
    ...
    <div id="tudo">
     ...
     <div id="tudo1">
         <Br>
         <center><input type="submit" value="Pesquisar pelo Número do Projeto" onclick="location.href='pesquisarNumero.jsp' "></center>
         <Br>
           ...
           if(numero!= null)
       {
           ...
           request.getRequestDispatcher("pesquisarNumero").forward(request, response);           
       }
